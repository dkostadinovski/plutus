jQuery("#simulation")
  .on("click", ".s-45d769b1-c24d-40fd-ab4d-704dfb328e09 .click", function(event, data) {
  ...
  .on("pageload", ".s-45d769b1-c24d-40fd-ab4d-704dfb328e09 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
